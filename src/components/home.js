...
import logosm from '../Images/science-math.gif';
import logocomm from '../Images/commerce.png';
               ...
               <Row>
                   <Col sm={6} xs={12}>
                        <FirstWrapper>
                            ...
                            <p>We with the help of our experts will help student to understand the complex concept in an easy way.</p>
                            <p> Enroll with our online and offline  programs with our experts and give your career a lift.</p>
                        </FirstWrapper>
                    </Col>
                    <Col sm={6} xs={12}>
